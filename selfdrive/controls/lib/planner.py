...
class Planner():
  ...
  def update(self, sm, pm, CP, VM, PP):
    ...
    if self.slowdown_for_curves and len(sm['model'].path.poly):  # old slowdown for curves code
